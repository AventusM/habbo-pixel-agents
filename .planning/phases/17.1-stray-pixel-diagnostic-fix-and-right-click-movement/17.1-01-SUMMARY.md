...
plan: "01"
subsystem: rendering
tags: [canvas, compositing, spritesheet, pixel-art, pngjs, diagnostics]

# Dependency graph
requires:
  - phase: 14.1-avatar-facial-features
    provides: Face rendering with hh_human_face spritesheet and tint canvas compositing
  - phase: 17-bugfixes-and-wishlist
    provides: Initial clearRect fix for tint canvas residual pixels (17-02)
provides:
...
affects: [avatar-rendering, asset-pipeline]

# Tech tracking
tech-stack:
  added: [pngjs]
  patterns: [imageSmoothingEnabled=false on all offscreen tint canvases]

key-files:
  created: [scripts/check-spritesheet-stray-pixels.mjs]
  modified: [src/isoAvatarRenderer.ts, src/avatarBuilderPreview.ts]
