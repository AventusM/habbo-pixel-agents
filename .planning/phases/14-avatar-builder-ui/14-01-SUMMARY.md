...
plan: 01
subsystem: ui
tags: [avatar, outfit, catalog, presets, cortex-assets, figure-sprites]

# Dependency graph
requires:
  - phase: 05-avatar-system
    provides: 11-layer Nitro figure composition, FIGURE_PARTS registry, VARIANT_OUTFITS colors
provides:
...
affects: [14-02-PLAN, 14-03-PLAN, isoAvatarRenderer]

# Tech tracking
tech-stack:
  added: []
  patterns: [outfit-config-type-system, curated-catalog-with-setid-validation, gender-filtered-catalog]
...
requirements-completed: [P14-01, P14-05, P14-06]
