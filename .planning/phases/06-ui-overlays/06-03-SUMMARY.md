...
plan: 03
subsystem: ui
tags: [font-bundling, press-start-2p, font-face, csp, fout-prevention]

# Dependency graph
requires:
  - phase: 06-ui-overlays-01
    provides: Speech bubble renderer using ctx.font = '8px "Press Start 2P"'
  - phase: 06-ui-overlays-02
    provides: Name tag renderer using ctx.font = '8px "Press Start 2P"'
  - phase: 02-static-room-rendering
    provides: Extension webview HTML generation pattern
provides:
...
affects: [07-agent-integration]

# Tech tracking
tech-stack:
  added: [press-start-2p-font]
  patterns: [font-display-block, font-preload, csp-font-src]
...
requirements-completed: [UI-06, UI-07, UI-08, AGENT-01]
