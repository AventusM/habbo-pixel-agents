...
plan: 02
subsystem: ui
tags: [canvas2d, name-tag, status-dot, rgba-transparency]

# Dependency graph
requires:
  - phase: 06-ui-overlays-01
    provides: Speech bubble renderer and RoomCanvas UI overlay integration pattern
  - phase: 01-coordinate-foundation
    provides: tileToScreen coordinate conversion for tag anchoring
provides:
...
tech-stack:
  added: []
  patterns: [rgba-transparency, status-color-mapping, pill-shaped-backgrounds]
