...
tags: [ffmpeg, ogg-vorbis, audio-conversion, build-automation]

# Dependency graph
requires:
  - phase: 03-asset-pipeline
    provides: esbuild configuration and asset bundling patterns
provides:
...
affects: [08-audio, future audio asset additions]

# Tech tracking
tech-stack:
  added: [FFmpeg libvorbis codec, bash build scripts]
  patterns: [Build-time asset conversion, graceful dependency handling]

key-files:
  created: [scripts/convert-audio-to-ogg.sh, scripts/obtain-habbo-sounds.md, assets/sounds-source/.gitkeep]
