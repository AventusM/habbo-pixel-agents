...
plan: 01
subsystem: ui
tags: [avatar, face, eyes, mouth, blink, cortex-assets, canvas-2d]

# Dependency graph
requires:
  - phase: 14-avatar-builder-ui
    provides: OutfitConfig type system, 11-layer figure composition, avatar builder modal
  - phase: 05-avatar-system
    provides: AvatarSpec with blinkFrame, drawTintedBodyPart, mapBodyDirection
provides:
...
affects: [avatar-builder-ui, avatar-expressions]

# Tech tracking
tech-stack:
  added: [hh_human_face cortex-asset (295 frames)]
  patterns: [face-direction-filtering, eye-blink-action-mapping, no-tint-for-eyes]
...
requirements-completed: [FACE-01, FACE-02, FACE-03, FACE-04, FACE-05, FACE-06, FACE-07]
