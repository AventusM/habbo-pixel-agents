...
patterns_established:
  - "Face direction filtering: skip ey/fc when mappedDir is 0 or 7"
  - "Blink action mapping: blinkFrame > 0 selects eyb action for eye sprites"
  - "Face parts use hh_human_face asset directly, bypassing figureParts lookup"
