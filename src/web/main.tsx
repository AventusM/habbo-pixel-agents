...
(window as any).ASSET_URIS = {
  ...
  pixellabPng: `${ASSET_BASE}/pixellab/beanie-hoodie-guy.png`,
  pixellabJson: `${ASSET_BASE}/pixellab/beanie-hoodie-guy.json`,
  plPlanningPng: `${ASSET_BASE}/pixellab/pl-planning.png`,
  plPlanningJson: `${ASSET_BASE}/pixellab/pl-planning.json`,
  plCoreDevPng: `${ASSET_BASE}/pixellab/pl-core-dev.png`,
  plCoreDevJson: `${ASSET_BASE}/pixellab/pl-core-dev.json`,
  plInfrastructurePng: `${ASSET_BASE}/pixellab/pl-infrastructure.png`,
  plInfrastructureJson: `${ASSET_BASE}/pixellab/pl-infrastructure.json`,
  plSupportPng: `${ASSET_BASE}/pixellab/pl-support.png`,
  plSupportJson: `${ASSET_BASE}/pixellab/pl-support.json`,
};
